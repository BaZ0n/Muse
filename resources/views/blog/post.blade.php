...
@section("main_content")
    ...
    <div class="container my-3 px-5" style="color:white; font-family:Roboto; margin-left:0%; width:fit-content; min-width:100%; min-height:500px; max-height:fit-content">
        <div class="container mx-3 px-0" style="background-color: #141615; border-radius: 5px; display: flex; width:fit-content; min-width:100%; min-height:500px; max-height:fit-content; align-content: space-between; flex-wrap: wrap;">
            <div class="container mt-4 px-0">
                <h2 id="postTitle" class="text-center py-3 px-5 fs-2">{{$post->title}}</h2>
